...
function Qiniu_Put($upToken, $key, $body, $putExtra) // => ($putRet, $err)
{
	...
	return Qiniu_Client_CallWithMultipartForm($client, Conf_QiNiu::QINIU_UP_HOST, $fields, $files);
}
...
function Qiniu_PutFile($upToken, $key, $localFile, $putExtra) // => ($putRet, $err)
{
	...
	$client = new Qiniu_HttpClient;
	return Qiniu_Client_CallWithForm($client, Conf_QiNiu::QINIU_UP_HOST, $fields, 'multipart/form-data');
}
