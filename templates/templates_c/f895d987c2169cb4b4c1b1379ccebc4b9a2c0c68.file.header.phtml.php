...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '63027461852424f138e57d0-61273658',
  'function' => 
  array (
  ),
    ...
    <header class="header">
        <div class="header-wrap clearfix">
            ...
            <div class="login-info clearfix">
                <a class="message-num" href="#" title="2条新消息">2</a>
                <div class="info-username clearfix">
                    <a class="info-userlink" href="#" title="meixiaofang">mayxiaofang</a>
                    <b></b>
                    <ul class="user-menu">
                ...
                <div class="message j-message">
                    ...
                    <ul class="message-wrap">
                        <li class="message-item"><a href="#" title="fond">fond</a>、<a href="#" title="麦子老师">麦子老师</a>喜欢了你的日记<a href="#" title="《百望山秋游》">《百望山秋游》</li>
                        <li class="message-item"><a href="#" title="fond">fond</a>给你<a href="#" title="留言">留言</a>了</li>
                        <li class="message-item"><a href="#" title="2013年8月13日的日记">2013年8月13日的日记</a>有了一条评论</li>
                        <li class="message-item"><a href="#" title="《百望山秋游》">《百望山秋游》</a>有了一条评论</li>
                        <li class="message-item"><a href="#" title="fond">fond</a>给你<a href="#" title="留言">留言</a>了</li>
                        <li class="message-item"><a href="#" title="2013年8月13日的日记">2013年8月13日的日记</a>有了一条评论</li>
                    </ul>
                    <a href="#" class="message-close clearword j-message-close" title="关闭消息中心">关闭消息中心</a>
                </div>
            </div>
        </div>
    </header>
